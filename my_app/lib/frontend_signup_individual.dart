...
class AuthPage_indi extends StatefulWidget {
  @override
  _AuthPageState createState() => _AuthPageState();
}

class _AuthPageState extends State<AuthPage_indi> {
  @override
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          await callContractFunction("individual", "_signup", [
                            input_name,
                            input_email,
                            input_password,
                            input_contact_number,
